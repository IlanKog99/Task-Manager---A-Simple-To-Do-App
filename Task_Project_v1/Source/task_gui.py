"""
task_gui.py - Contains the TaskGUI class which builds the UI for the task app.
Uses customtkinter to create a dope interface for adding, editing, and managing tasks.
"""
...
class TaskGUI(ctk.CTk):
    ...
    def update_legend(self) -> None:
        """
        Method updates the color legend based on current settings.
    ...
    def toggle_disable_colors(self) -> None:
        """
        Method toggles the disable colors setting and refreshes the display.
        """
        self.display_tasks()
        self.update_legend()
    ...
    def display_tasks(self) -> None:
        """
        Method refreshes the task list in the scrollable frame.
        
        Filters tasks based on the search query and the show completed switch,
        then sorts and displays them with proper colors.
        """
    ...
    def search_tasks(self, event) -> None:
        """
        Method triggers a search based on the input in the search entry.
        """
        self.display_tasks()

    def toggle_completed(self) -> None:
        """
        Method toggles the visibility of completed tasks.
        
        Updates the switch color and refreshes the task list.
        """
        if self.show_completed_var.get():
    ...
    def open_task_detail(self, task: Task) -> None:
        """
        Method opens a modal window showing details for a task.
        ...
        def toggle_completion():
            """
            Inner func toggles the task's completion status.
            """
        ...
        def open_edit():
            """
            Inner func closes the detail window and opens the edit modal.
            """
            detail_window.destroy()
        ...
        def delete_task():
            """
            Inner func deletes the task after a confirmation.
            """
    ...
    def open_add_task_modal(self) -> None:
        """
        Method opens a modal window to add a new task.
        """
        ...
        def submit_task():
            """
            Inner func validates the input and adds the new task.
            """
    ...
    def open_edit_task_modal(self, task: Task) -> None:
        """
        Method opens a modal window to edit an existing task.
        """
        modal = ctk.CTkToplevel(self)
        ...
        def submit_edit():
            """
            Inner func saves the changes made to the task.
            """
    ...
    def export_tasks(self) -> None:
        """
        Method exports incomplete tasks to a text file in the current directory.
        """
    ...
    def on_close(self) -> None:
        """
        Method saves tasks and closes the app.
        """
        self.task_manager.save()
        self.destroy()
